...
public class ControllerStatus extends AsyncTask<String, Void, String>{
	private String URL;
	public static AsyncResponse delegate=null;
	private ProgressDialog pd;
	private Activity activity;
	
	public ControllerStatus(View rootView, Activity activity){
	...
	protected String doInBackground(String... param) {
		URL = param[0];
		return recuperarStatus(param[1]);
	}
	@Override
	...
	private String recuperarStatus(String login) {
		String respStr;
