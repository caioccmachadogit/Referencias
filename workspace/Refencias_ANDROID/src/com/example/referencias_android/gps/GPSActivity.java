...
public class GPSActivity extends Activity {
	...
	private void ObterLocalizacao() {
		...
		// ADQUIRI UMA REFERÊNCIA PARA O SISTEMA DE LOCALIZAÇÃO
		...
		if (gpsUtills.RegistrarGPSCriteria()) {
			...
			Toast.makeText(this, "Localização Recebida! via "+gpsUtills.provider, Toast.LENGTH_SHORT).show();
	...
	private void openAlertConfirma() {
		...
		alertDialogBuilder.setTitle(this.getTitle() + " Atenção");
		alertDialogBuilder
				.setMessage("Não foi possível obter a localização, verifique seu GPS!");
