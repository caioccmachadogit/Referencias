package br.exemplosendimageforphp.domain;
...
import br.exemplosendimageforphp.util.Base64;
...
public class Image {
	...
	public static void gravarBitmap(Bitmap bmp){
	    try {                
	        ByteArrayOutputStream stream = new ByteArrayOutputStream();
	        bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);

	        byte[] bytes = stream.toByteArray();;
	        String nomeArquivo = android.os.Environment.getExternalStorageDirectory()+ "/img.png";
